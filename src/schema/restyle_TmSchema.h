...
//
    ...
    TM_PROP(5112, TMT, HCTEXTCOLOR, "HcTextColor", HIGHCONTRASTCOLORTYPE)
    TM_PROP(5113, TMT, HCEDGEHIGHLIGHTCOLOR, "HcEdgeHighlightColor", HIGHCONTRASTCOLORTYPE)
    TM_PROP(5114, TMT, HCEDGESHADOWCOLOR, "HcEdgeShadowColor", HIGHCONTRASTCOLORTYPE)
    TM_PROP(5115, TMT, HCTEXTBORDERCOLOR, "HcTextBorderColor", HIGHCONTRASTCOLORTYPE)
    TM_PROP(5116, TMT, HCTEXTSHADOWCOLOR, "HcTextShadowColor", HIGHCONTRASTCOLORTYPE)
    TM_PROP(5117, TMT, HCGLOWCOLOR, "HcGlowColor", HIGHCONTRASTCOLORTYPE)
    TM_PROP(5118, TMT, HCHEADING1TEXTCOLOR, "HcHeading1TextColor", HIGHCONTRASTCOLORTYPE)
    TM_PROP(5119, TMT, HCHEADING2TEXTCOLOR, "HcHeading2TextColor", HIGHCONTRASTCOLORTYPE)
    TM_PROP(5120, TMT, HCBODYTEXTCOLOR, "HcBodyTextColor", HIGHCONTRASTCOLORTYPE)
    TM_PROP(5121, TMT, HCGLYPHCOLOR, "HcGlyphColor", HIGHCONTRASTCOLORTYPE)
    TM_PROP(5122, TMT, HCHOTTRACKING, "HcHotTracking", HIGHCONTRASTCOLORTYPE)
    ...
    // --- atlas (v4 only) ---
    // unused prop that conflicts with TMT_ATLASIMAGE primitive type, safe to comment out methinks
    //TM_PROP(8000, TMT, ATLASIMAGE, "AtlasImage", ATLASIMAGE)
    TM_PROP(8001, TMT, ATLASINPUTIMAGE, "AtlasInputImage", ATLASIMAGE)
