...
BEGIN_TM_PROPS()
    ...
    TM_PROP(213, TMT, DISKSTREAM, "DiskStream", DISKSTREAM)
    ...
    TM_PROP(240, TMT, IMAGEPROPERTIES, "ImageProperties", IMAGEPROPERTIES)
    TM_PROP(241, TMT, HCCOLOR, "HcColor",                         HCCOLOR)
    TM_PROP(242, TMT, BITMAPIMAGE, "BitmapImage",             BITMAPIMAGE)
    TM_PROP(243, TMT, COMPOSEDIMAGE, "ComposedImage",       COMPOSEDIMAGE)
...
//
    ...
    TM_PROP(5110, TMT, HCBORDERCOLOR, "HcBorderColor", HCCOLOR)
    TM_PROP(5111, TMT, HCFILLCOLOR, "HcFillColor", HCCOLOR)
    TM_PROP(5112, TMT, HCTEXTCOLOR, "HcTextColor", HCCOLOR)
    TM_PROP(5113, TMT, HCEDGEHIGHLIGHTCOLOR, "HcEdgeHighlightColor", HCCOLOR)
    TM_PROP(5114, TMT, HCEDGESHADOWCOLOR, "HcEdgeShadowColor", HCCOLOR)
    TM_PROP(5115, TMT, HCTEXTBORDERCOLOR, "HcTextBorderColor", HCCOLOR)
    TM_PROP(5116, TMT, HCTEXTSHADOWCOLOR, "HcTextShadowColor", HCCOLOR)
    TM_PROP(5117, TMT, HCGLOWCOLOR, "HcGlowColor", HCCOLOR)
    TM_PROP(5118, TMT, HCHEADING1TEXTCOLOR, "HcHeading1TextColor", HCCOLOR)
    TM_PROP(5119, TMT, HCHEADING2TEXTCOLOR, "HcHeading2TextColor", HCCOLOR)
    TM_PROP(5120, TMT, HCBODYTEXTCOLOR, "HcBodyTextColor", HCCOLOR)
    TM_PROP(5121, TMT, HCGLYPHCOLOR, "HcGlyphColor", HCCOLOR)
    TM_PROP(5122, TMT, HCHOTTRACKING, "HcHotTracking", HCCOLOR)
...
//---------------------------------------------------------------------------------------
BEGIN_TM_CLASS_PARTS_FOR_OS(TASKBAND2, ESupportedOS::Win7 | ESupportedOS::Win8 | ESupportedOS::Win81)
    TM_PART(1, W7_TDP2, NEGATIVESPACEBOTTOM, "NegativeSpaceBottom")
    TM_PART(2, W7_TDP2, NEGATIVESPACETOP, "NegativeSpacetop")
    TM_PART(3, W7_TDP2, NEGATIVESPACELEFT, "NegativeSpaceLeft")
    TM_PART(4, W7_TDP2, NEGATIVESPACERIGHT, "NegativeSpaceRight")
    TM_PART(5, W7_TDP2, SINGLEBUTTON, "SingleButton")
    TM_PART(6, W7_TDP2, GROUPLEFT, "GroupLeft")
    TM_PART(7, W7_TDP2, GROUPMIDDLE, "GroupMiddle")
    TM_PART(8, W7_TDP2, GROUPRIGHT, "GroupRight")
    TM_PART(9, W7_TDP2, PROGRESSNORMAL, "ProgressNormal")
    TM_PART(10, W7_TDP2, PROGRESSINDETERMINATE, "ProgressIndeterminate")
    TM_PART(11, W7_TDP2, PROGRESSERROR, "ProgressError")
    TM_PART(12, W7_TDP2, PROGRESSPAUSED, "ProgressPaused")
    TM_PART(13, W7_TDP2, TILESTACKS, "TileStacks")
    TM_PART(14, W7_TDP2, ACTIVETILESTACKS, "ActiveTileStacks")
END_TM_CLASS_PARTS()
...
BEGIN_TM_PART_STATES(TILESTACKS)
    TM_STATE(1, TBTS, ONE, "One")
    TM_STATE(2, TBTS, TWO, "Two")
    TM_STATE(3, TBTS, THREEORMORE, "ThreeOrMore")
END_TM_PART_STATES()
...
// V4:
BEGIN_TM_CLASS_PARTS_FOR_OS(STARTPANELPRIV, ESupportedOS::Win7 | ESupportedOS::Win8)
    TM_PART(1, W7_SPPP, USERPANE, "UserPane")
    TM_PART(2, W7_SPPP, MOREPROGRAMS, "MorePrograms")
    TM_PART(3, W7_SPPP, MOREPROGRAMSDEST, "MoreProgramsDest")
    TM_PART(4, W7_SPPP, MOREPROGRAMSARROW, "MoreProgramsArrow")
    TM_PART(5, W7_SPPP, FLYOUTARROW, "FlyoutArrow")
    TM_PART(6, W7_SPPP, PROGLIST, "ProgList")
    TM_PART(7, W7_SPPP, PROGLISTDEST, "ProgListDest")
    TM_PART(8, W7_SPPP, PROGLISTSEPARATOR, "ProgListSeparator")
    TM_PART(9, W7_SPPP, PLACESLIST, "PlacesList")
    TM_PART(10, W7_SPPP, DESTLIST, "DestList")
    TM_PART(11, W7_SPPP, PLACESLISTSEPARATOR, "PlacesListSeparator")
    TM_PART(12, W7_SPPP, DESTINATIONMENUTOP, "DestinationMenuTop")
    TM_PART(13, W7_SPPP, DESTINATIONMENUBOTTOM, "DestinationMenuBottom")
    TM_PART(14, W7_SPPP, LOGOFFBACKGROUND, "LogOffBackground")
    TM_PART(15, W7_SPPP, LOGOFFDESTBACKGROUND, "LogOffDestBackground")
    TM_PART(16, W7_SPPP, MOREPROGRAMSTAB, "MoreProgramsTab")
    TM_PART(17, W7_SPPP, NSCHOST, "NscHost")
    TM_PART(18, W7_SPPP, OPENBOX, "OpenBox")
    TM_PART(19, W7_SPPP, OPENBOXDEST, "OpenBoxDest")
    TM_PART(20, W7_SPPP, SEARCHVIEW, "SearchView")
    TM_PART(21, W7_SPPP, MOREPROGRAMSARROWBACK, "MoreProgramsArrowBack")
    TM_PART(22, W7_SPPP, TOPMATCH, "TopMatch")
    TM_PART(23, W7_SPPP, LOGOFFSPLITBUTTONDROPDOWN, "LogOffSplitButtonDropdown")
    TM_PART(24, W7_SPPP, LOGOFFSPLITBUTTONDROPDOWNDEST, "LogOffSplitButtonDropdownDest")
    TM_PART(25, W7_SPPP, PINICON, "Pinicon")
    TM_PART(26, W7_SPPP, SMALLPINOFFSET, "SmallPinOffset")
    TM_PART(27, W7_SPPP, LARGEPINOFFSET, "LargePinOffset")
    TM_PART(28, W7_SPPP, LEFTMFUBUTTON, "LeftMFUButton")
    TM_PART(29, W7_SPPP, FULLMFUBUTTON, "FullMFUButton")
    TM_PART(30, W7_SPPP, CENTERMFUBUTTON, "CenterMFUButton")
    TM_PART(31, W7_SPPP, RIGHTMFUBUTTON, "Rightmfubutton")
    TM_PART(32, W7_SPPP, FULLPLACESBUTTON, "FullPlacesButton")
    TM_PART(33, W7_SPPP, LEFTPLACESBUTTON, "LeftPlacesButton")
    TM_PART(34, W7_SPPP, CENTERPLACESBUTTON, "CenterPlacesButton")
    TM_PART(35, W7_SPPP, RIGHTPLACESBUTTON, "RightPlacesButton")
    TM_PART(36, W7_SPPP, SPECIALFOLDERSBUTTON, "SpecialFoldersButton")
    TM_PART(37, W7_SPPP, LOGOFFSPLITBUTTON, "LogOffSplitButton")
    TM_PART(38, W7_SPPP, LOGOFFSPLITBUTTONDEST, "LogOffSplitButtonDest")
END_TM_CLASS_PARTS()

BEGIN_TM_CLASS_PARTS_FOR_OS(STARTPANELPRIV, ESupportedOS::Win81)
    TM_PART(1, W81_SPPP, DESTLIST, "DestList")
    TM_PART(2, W81_SPPP, PLACESLISTSEPARATOR, "PlacesListSeparator")
    TM_PART(3, W81_SPPP, DESTINATIONMENUTOP, "DestinationMenuTop")
    TM_PART(4, W81_SPPP, DESTINATIONMENUBOTTOM, "DestinationMenuBottom")
    TM_PART(5, W81_SPPP, MOREPROGRAMSTAB, "MoreProgramsTab")
    TM_PART(6, W81_SPPP, PINICON, "PinIcon")
    TM_PART(7, W81_SPPP, SMALLPINOFFSET, "SmallPinOffset")
    TM_PART(8, W81_SPPP, LARGEPINOFFSET, "LargePinOffset")
    TM_PART(9, W81_SPPP, CENTERMFUBUTTON, "CenterMFUButton")
    TM_PART(10, W81_SPPP, FULLPLACESBUTTON, "FullPlacesButton")
    TM_PART(11, W81_SPPP, LEFTPLACESBUTTON, "LeftPlacesButton")
    TM_PART(12, W81_SPPP, RIGHTPLACESBUTTON, "RightPlacesButton")
END_TM_CLASS_PARTS()
...
//---------------------------------------------------------------------------------------
BEGIN_TM_CLASS_PARTS_FOR_OS(ALTTAB, ESupportedOS::WinVista | ESupportedOS::Win7)
    TM_PART(1, VISTA_ATP, HOVERRECT, "HoverRect")
    TM_PART(2, VISTA_ATP, FOCUSRECT, "FocusRect")
    TM_PART(3, VISTA_ATP, WINDOWTEXT, "WindowText")
    TM_PART(4, VISTA_ATP, SHADOW, "Shadow")
    TM_PART(5, VISTA_ATP, FOCUSHOVERRECT, "FocusHoverRect")
END_TM_CLASS_PARTS()

BEGIN_TM_CLASS_PARTS(ALTTAB)
    TM_PART(1, ATP, WINDOWTEXT, "WindowText")
    TM_PART(2, ATP, SHADOW, "Shadow")
END_TM_CLASS_PARTS()
...
// Adds FileNameDisconnectedProperty and FileNameSelectedDisconnectedProperty states
BEGIN_TM_PART_STATES_FOR_OS(PROPERTY, ESupportedOS::Win10_1703 | ESupportedOS::Win11_22H2)
    TM_STATE(1, IVP_RS2, SUBPROPERTY, "SubProperty")
    TM_STATE(2, IVP_RS2, FILENAMEPROPERTY, "FileNameProperty")
    TM_STATE(3, IVP_RS2, FILENAMESELECTEDPROPERTY, "FileNameSelectedProperty")
    TM_STATE(4, IVP_RS2, SUBPROPERTYSELECTED, "SubPropertySelected")
    TM_STATE(5, IVP_RS2, FILENAMECOMPRESSEDPROPERTY, "FileNameCompressedProperty")
    TM_STATE(6, IVP_RS2, FILENAMESELECTEDCOMPRESSEDPROPERTY, "FileNameSelectedCompressedProperty")
    TM_STATE(7, IVP_RS2, FILENAMEENCRYPTEDPROPERTY, "FileNameEncryptedProperty")
    TM_STATE(8, IVP_RS2, FILENAMESELECTEDENCRYPTEDPROPERTY, "FileNameSelectedEncryptedProperty")
    TM_STATE(9, IVP_RS2, FILENAMEDISCONNECTEDPROPERTY, "FileNameDisconnectedProperty")
    TM_STATE(10, IVP_RS2, FILENAMESELECTEDDISCONNECTEDPROPERTY, "FileNameSelectedDisconnectedProperty")
    TM_STATE(11, IVP_RS2, CONFLICTTILETEXT, "ConflictTileText")
    TM_STATE(12, IVP_RS2, CONFLICTTILETEXTFOCUSED, "ConflictTileTextFocused")
    TM_STATE(13, IVP_RS2, PROGRESSBAR, "ProgressBar")
END_TM_PART_STATES()
...
BEGIN_TM_PART_STATES(PROPERTY)
    ...
    TM_STATE(9, IVP, CONFLICTTILETEXT, "ConflictTileText")
    TM_STATE(10, IVP, CONFLICTTILETEXTFOCUSED, "ConflictTileTextFocused")
    TM_STATE(11, IVP, PROGRESSBAR, "ProgressBar")
END_TM_PART_STATES()
...
BEGIN_TM_PART_STATES(LEFTHIGHLIGHTCORNER)
    TM_STATE(1, DWMLHCS, ACTIVE, "Active")
    TM_STATE(2, DWMLHCS, INACTIVE, "Inactive")
    TM_STATE(3, DWMLHCS, MAXACTIVE, "MaxActive")
...
BEGIN_TM_PART_STATES(REFLECTIONMAP)
    TM_STATE(1, DWMRMS, ACTIVE, "Active")
    TM_STATE(2, DWMRMS, INACTIVE, "Inactive")
    TM_STATE(3, DWMRMS, MAXACTIVE, "MaxActive")
    TM_STATE(4, DWMRMS, MAXINACTIVE, "MaxInactive")
END_TM_PART_STATES()

BEGIN_TM_PART_STATES(SIDEHIGHLIGHT)
    TM_STATE(1, DWMSHS, ACTIVE, "Active")
    TM_STATE(2, DWMSHS, INACTIVE, "Inactive")
END_TM_PART_STATES()
//---------------------------------------------------------------------------------------
...
BEGIN_TM_CLASS_PARTS_FOR_OS(ANIMATIONSPRIV, ESupportedOS::Win81)
    // This one continues from where "Animations" leaves off. It's contiguous with the animations definitions.
    // This distinction was on Microsoft's part. It seems that AnimationsPriv was never exposed to UxTheme,
    // but was exposed to DWM.
    // These names are taken from Lucas Brooks' Windows 8.1 theme dump:
    ...
    TM_PART(56, TAS_W81, LAUNCHERLAUNCH, "LauncherLaunch")
    TM_PART(57, TAS_W81, LAUNCHERDISMISS, "LauncherDismiss")
    TM_PART(58, TAS_W81, APPLAUNCH, "AppLaunch")
    TM_PART(59, TAS_W81, APPSWITCH, "AppSwitch")
    TM_PART(60, TAS_W81, TAPDOWN3D, "TapDown3D")
    TM_PART(61, TAS_W81, TAPUP3D, "TapUp3D")
    TM_PART(62, TAS_W81, THUMBNAIL, "Thumbnail")
    TM_PART(63, TAS_W81, RESIZE, "Resize")
    TM_PART(64, TAS_W81, NOANIMATION, "NoAnimation")
    TM_PART(65, TAS_W81, UNLOCK, "Unlock")
    TM_PART(66, TAS_W81, TDBN, "Tdbn")
    TM_PART(67, TAS_W81, APPARRANGEMENTIMMEDIATE, "AppArrangementImmediate")
    TM_PART(68, TAS_W81, APPARRANGEMENTDELAYED, "AppArrangementDelayed")
    TM_PART(69, TAS_W81, APPLAUNCHSWITCH, "AppLaunchSwitch")
    TM_PART(70, TAS_W81, CHANGEPANEL, "ChangePanel")
    TM_PART(71, TAS_W81, GROWPANEL, "GrowPanel")
    TM_PART(72, TAS_W81, SHRINKPANEL, "ShrinkPanel")
    TM_PART(73, TAS_W81, TILENOTIFICATION, "TileNotification")
    TM_PART(74, TAS_W81, IMMERSIVEBACKGROUND, "ImmersiveBackground")
    TM_PART(75, TAS_W81, SSCROSSFADE, "SSCrossFade")
    TM_PART(76, TAS_W81, SCREENROTATION, "ScreenRotation")
    TM_PART(77, TAS_W81, INPLACERESIZE, "InplaceResize")
    TM_PART(78, TAS_W81, DIALOGSWITCH, "DialogSwitch")
    TM_PART(79, TAS_W81, LOGONENTERPAGE, "LogonEnterPage")
    TM_PART(80, TAS_W81, CROSSFADEINPLACE, "CrossfadeInPlace")
    TM_PART(81, TAS_W81, SCREENSHOTFADEOUT, "ScreenshotFadeOut")
    TM_PART(82, TAS_W81, SHOWCHARM, "ShowCharm")
    TM_PART(83, TAS_W81, HIDECHARM, "HideCharm")
    TM_PART(84, TAS_W81, FADEINLONG, "FadeInLong")
    TM_PART(85, TAS_W81, FADEOUTLONG, "FadeOutLong")
    TM_PART(86, TAS_W81, ADDTOGRIDSTAGGERED, "AddToGridStaggered")
    TM_PART(87, TAS_W81, DELETEFROMGRIDSTAGGERED, "DeleteFromGridStaggered")
    TM_PART(88, TAS_W81, DRAGSOURCESTARTMULTI, "DragSourceStartMulti")
    TM_PART(89, TAS_W81, DRAGSOURCEENDMULTI, "DragSourceEndMulti")
    TM_PART(90, TAS_W81, VIRTUALDESKTOPSWITCH, "VirtualDesktopSwitch")
    TM_PART(91, TAS_W81, TABLETMODETRANSITION, "TabletModeTransition")
END_TM_CLASS_PARTS()

BEGIN_TM_CLASS_PARTS(ANIMATIONSPRIV)
    // This one continues from where "Animations" leaves off. It's contiguous with the animations definitions.
    // This distinction was on Microsoft's part. It seems that AnimationsPriv was never exposed to UxTheme,
    // but was exposed to DWM.
    // These names are taken from DWM 6.2.8175.5:
    TM_PART(37, TAS, WINDOWOPEN, "WindowOpen")
    TM_PART(38, TAS, WINDOWCLOSE, "WindowClose")
    TM_PART(39, TAS, WINDOWMINIMIZE, "WindowMinimize")
    TM_PART(40, TAS, WINDOWRESTOREFROMMINIMIZED, "WindowRestoreFromMinimized")
    TM_PART(41, TAS, LOGIN, "Login")
    TM_PART(42, TAS, LAUNCHERLAUNCH, "LauncherLaunch")
    TM_PART(43, TAS, LAUNCHERDISMISS, "LauncherDismiss")
    TM_PART(44, TAS, APPLAUNCH, "AppLaunch")
    TM_PART(45, TAS, APPSWITCH, "AppSwitch")
    TM_PART(46, TAS, SUBTLENOTIFY, "SubtleNotify")
    TM_PART(47, TAS, TAPDOWN3D, "TapDown3D")
    TM_PART(48, TAS, TAPUP3D, "TapUp3D")
    TM_PART(49, TAS, THUMBNAIL, "Thumbnail")
    TM_PART(50, TAS, RESIZE, "Resize")
    TM_PART(51, TAS, NOANIMATION, "NoAnimation")
    TM_PART(52, TAS, UNLOCK, "Unlock")
    TM_PART(53, TAS, TDBN, "Tdbn")
    TM_PART(54, TAS, APPARRANGEMENTIMMEDIATE, "AppArrangementImmediate")
    TM_PART(55, TAS, APPARRANGEMENTDELAYED, "AppArrangementDelayed")
    TM_PART(56, TAS, APPLAUNCHSWITCH, "AppLaunchSwitch")
    TM_PART(57, TAS, CHANGEPANEL, "ChangePanel")
    TM_PART(58, TAS, GROWPANEL, "GrowPanel")
    TM_PART(59, TAS, SHRINKPANEL, "ShrinkPanel")
    TM_PART(60, TAS, TILENOTIFICATION, "TileNotification")
    TM_PART(61, TAS, IMMERSIVEBACKGROUND, "ImmersiveBackground")
    TM_PART(62, TAS, APPLAUNCHWITHTILE, "AppLaunchWithTile")
    TM_PART(63, TAS, SSCROSSFADE, "SSCrossFade")
    TM_PART(64, TAS, SCREENROTATION, "ScreenRotation")
    TM_PART(65, TAS, INPLACERESIZE, "InplaceResize")
    TM_PART(66, TAS, DIALOGSWITCH, "DialogSwitch")
    TM_PART(67, TAS, LOGONENTERPAGE, "LogonEnterPage")
END_TM_CLASS_PARTS()
...
BEGIN_TM_PART_STATES(WINDOWOPEN)
    TM_STATE(1, TA_WINDOWOPEN, TARGET, "Target")
END_TM_PART_STATES()

BEGIN_TM_PART_STATES(WINDOWCLOSE)
    TM_STATE(1, TA_WINDOWCLOSE, TARGET, "Target")
END_TM_PART_STATES()

BEGIN_TM_PART_STATES(WINDOWMINIMIZE)
    TM_STATE(1, TA_WINDOWMINIMIZE, TARGET, "Target")
END_TM_PART_STATES()

BEGIN_TM_PART_STATES(WINDOWRESTOREFROMMINIMIZED)
    TM_STATE(1, TA_WINDOWRESTOREFROMMINIMIZED, TARGET, "Target")
END_TM_PART_STATES()
...
BEGIN_TM_PART_STATES(LIBRARYPANEIDENTIFIER)
    TM_STATE(1, CMLPI, NORMAL, "Normal")
END_TM_PART_STATES()
