...
BEGIN_TM_CLASS_PARTS(CONTROLPANEL)
    ...
    TM_PART(3, CPANEL, NAVIGATIONPANELLABEL, "NavigationPanelLabel")
...
BEGIN_TM_CLASS_PARTS_FOR_OS(DWMWINDOW, ESupportedOS::Win8 | ESupportedOS::Win81 | ESupportedOS::Win10Th1 | ESupportedOS::Win10Th2)
