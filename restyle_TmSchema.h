...
BEGIN_TM_PART_STATES(RADIOBUTTON)
    ...
    TM_STATE(3, RBS, UNCHECKEDPRESSED, "UncheckedPushed")
    ...
    TM_STATE(7, RBS, CHECKEDPRESSED, "CheckedPushed")
...
BEGIN_TM_PART_STATES(CHECKBOX)
    ...
    TM_STATE(3, CBS, UNCHECKEDPRESSED, "UncheckedPushed")
...
BEGIN_TM_CLASS_PARTS(MENUBAND)
    ...
    TM_PART(2, MDP, SEPERATOR, "Separator")
END_TM_CLASS_PARTS()
